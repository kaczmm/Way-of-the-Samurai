...
def main():
        names = ['Motohito','Mihito','Hikohito','Fusahito','Katsuhito','Tomohito','Michihito','Kazuhito','Kotohito','Okiko','Tsuguhito','Nagahito','Satohito','Asahito','Toshiko',
                 'Yasuhito','Teruhito','Hidehito','Morohito','Ayahito','Takauji','Yoshiakira','Yoshimitsu','Yoshimochi','Yoshikazu','Yoshinori','Yoshikatsu','Yoshimasa','Yoshihisa',
                 'Yoshitane','Yoshizumi','Yoshiharu','Yoshiteru','Yoshihide','Yoshiaki','Nobutada','Hidenobu','Hideyoshi','Hideyori','Ieyasu','Hidetada','Iemitsu','Ietsuna','Tsunayoshi',
                 'Ienobu','Ietsugu','Yoshimune','Ieshige','Ieharu','Ienari','Ieyoshi','Iesada','Iemochi','Yoshinobu']
        clans = ['Amago','Arisugawa','Asaka','Asakura','Chosokabe','Date','Fushimi','Hojo','Hosokawa','Hatekayama','Ikeda','Imagawa','Katsura','Kaya','Kitashirakawa','Kuni','Maeda','Mori',
                 'Nanbu','Nashimoto','Oda','Otomo','Ouchi','Shiba','Shimazu','Takeda','Tokugawa','Uesugi','Yamana','Yamashina','Yamato']
